...
export default function Dashboard() {
  ...
  const links = [
    ...
    },
    {
      ...
      href: "#",
      icon: (
        <IconPlus className="h-5 w-5 shrink-0 transition-colors text-white" />
      ),
      tab: "Create"
    },
    {
      ...
      href: "#",
      icon: (
        <IconChartBar className="h-5 w-5 shrink-0 transition-colors text-white" />
      ),
      tab: "Analytics"
    },
    {
      ...
      href: "#",
      icon: (
        <IconCalendar className="h-5 w-5 shrink-0 transition-colors text-white" />
      ),
      tab: "Schedule"
    },
    {
      ...
      href: "#",
      icon: (
        <IconUserBolt className="h-5 w-5 shrink-0 transition-colors text-white" />
      ),
      tab: "Profile"
    },
    {
    ...
    },
    {
      ...
      href: "/login",
      icon: (
        <IconLogout className="h-5 w-5 shrink-0 transition-colors text-white" />
      ),
      tab: "Logout"
    },
  ];
  ...
  return (
    <div className={cn(
      "flex flex-col md:flex-row bg-slate-950 w-full flex-1 mx-auto border border-white/5 overflow-hidden relative",
      "h-screen"
    )}>
      {/* Background Component - Brighter Opacity */}
