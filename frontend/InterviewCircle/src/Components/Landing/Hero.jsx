              ...
              <>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div 
                    ...
                    className="w-20 h-20 bg-indigo-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform cursor-pointer shadow-xl shadow-indigo-500/20 z-10"
                  >
                ...
                <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between pointer-events-none">
                  ...
                  <p className="text-slate-400 text-sm font-medium">Watching demo of AI Technical Interview</p>
                </div>
              </>
            ) : (
              <iframe
                width="100%"
                height="100%"
                src="https://www.youtube.com/embed/srw4r3htm4U?autoplay=1"
                title="InterviewCircle AI Demo"
                frameBorder="0"
